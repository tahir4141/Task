...
<header>
    <h2> <label for="nav-toggle">
       ...
       animation: anime 6s linear infinite;">SuperAdmin Dashboard</span>
    </h2>
    @if(Session::has('user'))
    <div class="user-wrapper">
        ...
        <a href="{{ URL::to('/superadminLogout') }}" style="color: black">
            <button type="button" class="btn btn-primary">Logout</button>
        </a>
    </div>
    @else
    <li class="nav-item"><a href="{{URL::to('/superadminLogin') }}">Login</a></li>
    @endif
</header>
{{--
